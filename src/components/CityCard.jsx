...
export default function CityCard({
  ...
  return (
    <>
      {cityInfo && (
        <div className="w-full md:w-80 min-h-80 md:h-96 flex flex-col justify-between gap-y-2 rounded-md overflow-hidden shadow-lg bg-white bg-opacity-50 p-3 mb-5 lg:mb-0">
